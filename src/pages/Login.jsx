...
const LoginPage = () => {
  ...
  return (
    <div className="h-3/4 bg-gradient-to-br flex items-center justify-center p-4 mt-9">
      <div 
        className={`bg-white rounded-xl shadow-2xl p-8 w-full max-w-md transition-all duration-500 ease-in-out ${shake ? 'animate-shake' : ''}`}
      >
        ...
        <form onSubmit={handleSubmit} noValidate>
          ...
          <button
            ...
            className={`w-full py-3 px-4 rounded-lg bg-gradient-to-r from-blue-500 to-purple-600 hover:from-blue-600 hover:to-purple-700 text-white font-semibold shadow-md hover:shadow-lg transition-all duration-300 flex items-center justify-center ${isSubmitting ? 'opacity-75 cursor-not-allowed' : ''}`}
          >
            {isSubmitting ? (
              <>
        ...
        <div className="mt-6 text-center">
          <p className="text-sm text-gray-600">
            ...
            <Link to="/register" className='text-blue-600 font-bold'>Signup</Link>
          </p>
        </div>
      </div>
    </div>
